...
export function MobileNav() {
  ...
  return (
    <div 
      data-mobile-nav
      data-pwa-nav
      className="fixed bottom-0 left-0 right-0 z-[9999] md:hidden bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/80 border-t shadow-[0_-4px_12px_rgba(0,0,0,0.1)]"
      style={{
