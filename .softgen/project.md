...
## Design
- **Primary:** 186 78% 22% (hluboká modrozelená - voda)
- **Secondary:** 35 50% 65% (teplá písková - břeh)
- **Accent:** 150 45% 32% (svěží zelená - příroda)
...
- Detaily úlovku: nick rybáře, druh, míry, datum, čas, značka nástrahy
- Sdílení jednotlivých úlovků
- Registrace a přihlášení (nick/email + heslo)
